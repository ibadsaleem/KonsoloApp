...
const StreakStarted = ({navigation}) => {
    ...
    <LinearGradient
      ...
      <ScrollView style={{}} showsVerticalScrollIndicator={false}>
        ...
        <View >
            <Image
            source={require('../Images/StreakStart.png')}
            />
        </View>
        <View style={{}}>
            <Text style={{fontFamily:'Inter-Bold',fontSize:30,color:'#102054',marginTop:50}}>Streak Started</Text>
        </View>
        <View style={{width:'70%'}}>
        <Text style={{fontFamily:'Inter-Normal',fontSize:14,color:'grey',textAlign:'center',marginTop:10,lineHeight:25}}>Your Progress streak is Started</Text>
        </View>
